...
public class ViewCollectionsTest {
  ...
  private static final Action<View> ACTION_DISABLE =
      (view, index) -> view.setEnabled(false);
  private static final Action<View> ACTION_ZERO_ALPHA =
  ...
  @Test
  public void actionAppliedToView() {
    View view = new View(context);
    assertThat(view.isEnabled()).isTrue();
  ...
  @Test
  public void actionsAppliedToView() {
    View view = new View(context);
    assertThat(view.isEnabled()).isTrue();
  ...
  @Test
  public void actionAppliedToEveryViewInList() {
    View view1 = new View(context);
    View view2 = new View(context);
    View view3 = new View(context);
    assertThat(view1.isEnabled()).isTrue();
  ...
  @Test
  public void actionsAppliedToEveryViewInList() {
    View view1 = new View(context);
    View view2 = new View(context);
    View view3 = new View(context);
    assertThat(view1.isEnabled()).isTrue();
  ...
  @Test
  public void setterAppliedToView() {
    View view = new View(context);
    assertThat(view.isEnabled()).isTrue();
  ...
  @Test
  public void setterAppliedToEveryViewInList() {
    View view1 = new View(context);
    View view2 = new View(context);
    View view3 = new View(context);
    assertThat(view1.isEnabled()).isTrue();
