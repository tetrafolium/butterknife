...
public class RClassTest {
  ...
  private static final JavaFileObject NON_FINAL_R =
  ...
  private static final JavaFileObject FINAL_R = JavaFileObjects.forSourceString(
      "test.R",
      ""
          + "package test;\n"
          + "public final class R {\n"
  ...
  private static final JavaFileObject R2 = JavaFileObjects.forSourceString(
      "test.R2", ""
                     + "package test;\n"
  ...
  public void library() {
    ...
    assertAbout(javaSources())
        .that(asList(source, NON_FINAL_R, R2))
  ...
  public void issue779() {
    JavaFileObject r2Bar = JavaFileObjects.forSourceString(
        "test.bar.R2", ""
                           + "package test.bar;\n"
                           + "public final class R2 {\n"
                           + "  public static final class array {\n"
    ...
    JavaFileObject nonFinalRBar = JavaFileObjects.forSourceString(
        "test.bar.R",
        ""
            + "package test.bar;\n"
            + "public final class R {\n"
    ...
    JavaFileObject nonFinalRFoo = JavaFileObjects.forSourceString(
        "test.foo.R",
        ""
            + "package test.foo;\n"
            + "public final class R {\n"
    ...
    JavaFileObject r2Foo = JavaFileObjects.forSourceString(
        "test.foo.R2", ""
                           + "package test.foo;\n"
                           + "public final class R2 {\n"
                           + "  public static final class array {\n"
    ...
    JavaFileObject fooSource = JavaFileObjects.forSourceString(
        "test.foo.FooTest", ""
                                + "package test.foo;\n"
    ...
    JavaFileObject barSource = JavaFileObjects.forSourceString(
        "test.bar.Test", ""
                             + "package test.bar;\n"
                             + "import android.app.Activity;\n"
                             + "import butterknife.BindView;\n"
    ...
    JavaFileObject customView = JavaFileObjects.forSourceString(
        "test.bar.CustomView", ""
                                   + "package test.bar;\n"
                                   + "import android.view.View;\n"
                                   + "import android.content.Context;\n"
    ...
    JavaFileObject bindingSourceBar = JavaFileObjects.forSourceString(
        "test/Test_ViewBinding",
        ""
            + "// Generated code from Butter Knife. Do not modify!\n"
            + "package test.bar;\n\n"
    ...
    JavaFileObject bindingSourceFoo = JavaFileObjects.forSourceString(
        "test/FooTest_ViewBinding",
        ""
            + "// Generated code from Butter Knife. Do not modify!\n"
            + "package test.foo;\n\n"
            + "import android.view.View;\n"
    ...
    assertAbout(javaSources())
        .that(asList(customView, fooSource, barSource, nonFinalRBar,
                     nonFinalRFoo, r2Bar, r2Foo))
        .withCompilerOptions("-Xlint:-processing")
        .processedWith(new ButterKnifeProcessor())
        .compilesWithoutWarnings()
        .and()
  ...
  public void compiledRClass() {
    ...
    assertAbout(javaSources())
        .that(asList(source, NON_FINAL_R))
        .withCompilerOptions("-Xlint:-processing")
        .processedWith(new ButterKnifeProcessor())
        .compilesWithoutWarnings()
        .and()
