...
public class BindViewsTest {
  ...
  @Test
  public void bindingArrayNonDebuggable() {
    JavaFileObject source = JavaFileObjects.forSourceString(
        "test.Test", ""
                         + "package test;\n"
                         + "import android.view.View;\n"
  ...
  @Test
  public void bindingArrayWithCastNonDebuggable() {
    JavaFileObject source = JavaFileObjects.forSourceString(
        "test.Test", ""
                         + "package test;\n"
                         + "import android.widget.TextView;\n"
  ...
  public void bindingGeneratedView() {
    ...
    assertAbout(javaSources())
        ...
        .compilesWithoutError()
        .withNoteContaining(
            "@BindViews List or array with unresolved type (GeneratedView)")
        .and()
        .withNoteContaining(
  ...
  @Test
  public void bindingListWithGenerics() {
    JavaFileObject source = JavaFileObjects.forSourceString(
        "test.Test", ""
                         + "package test;\n"
                         + "import android.view.View;\n"
  ...
  public void failsIfNoIds() {
    ...
    assertAbout(javaSource())
        ...
        .failsToCompile()
        .withErrorContaining(
            "@BindViews must specify at least one ID. (test.Test.thing)")
        .in(source)
        .onLine(6);
  }
  ...
  @Test
  public void failsIfUnsupportedCollection() {
    JavaFileObject source = JavaFileObjects.forSourceString(
        "test.Test", ""
                         + "package test;\n"
                         + "import android.view.View;\n"
  ...
  @Test
  public void failsIfArrayNotView() {
    JavaFileObject source = JavaFileObjects.forSourceString(
        "test.Test", ""
                         + "package test;\n"
                         + "import butterknife.BindViews;\n"
  ...
  @Test
  public void bindingArrayWithRScanner() {
    JavaFileObject source = JavaFileObjects.forSourceString(
        "test.Test",
        ""
            + "package test;\n"
  ...
  @Test
  public void bindingArrayWithMixedRAndLiteral() {
    JavaFileObject source = JavaFileObjects.forSourceString(
        "test.Test",
        ""
            + "package test;\n"
