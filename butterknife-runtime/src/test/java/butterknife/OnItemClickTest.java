...
/**
 * This augments {@link OnClickTest} with tests that exercise callbacks with
 * parameters.
 */
public class OnItemClickTest {
  @Test
  public void onItemClickBinding() {
  ...
  @Test
  public void failsWithInvalidId() {
    JavaFileObject source = JavaFileObjects.forSourceString(
        "test.Test", ""
                         + "package test;\n"
                         + "import butterknife.OnItemClick;\n"
    ...
    assertAbout(javaSource())
        ...
        .failsToCompile()
        .withErrorContaining(
            "@OnItemClick annotation contains invalid ID -1. (test.Test.doStuff)")
        .in(source)
        .onLine(4);
  }
