...
public void asStringArray() {
	...
	String[] expected =
		context.getResources().getStringArray(R.array.string_one_two_three);
...
public void asIntArray() {
	...
	int[] expected =
		context.getResources().getIntArray(R.array.int_one_two_three);
...
public void asCharSequenceArray() {
	...
	CharSequence[] expected =
		context.getResources().getTextArray(R.array.int_one_two_three);
