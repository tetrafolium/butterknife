...
public final class OnLongClickTest {
  ...
  static final class Visibilities {
    ...
    @OnLongClick(3)
    protected boolean protectedClick() {
      clicks++;
      return true;
    }
  }
  ...
  static final class ArgumentCast {
    ...
    @OnLongClick(2)
    boolean clickTextView(TextView view) {
      last = view;
      return true;
    }

    @OnLongClick(3)
    boolean clickButton(Button view) {
      last = view;
      return true;
    }

    @OnLongClick(4)
    boolean clickMyInterface(MyInterface view) {
      last = (View)view;
      return true;
    }
  }
