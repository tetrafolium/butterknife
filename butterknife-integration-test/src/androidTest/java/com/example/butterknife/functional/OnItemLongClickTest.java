...
public final class OnItemLongClickTest {
  ...
  static final class Simple {
    ...
    @OnItemLongClick(1)
    boolean itemClick(int position) {
  ...
  static final class Visibilities {
    ...
    @OnItemLongClick(1)
    public boolean publicItemLongClick(int position) {
      clickedPosition = position;
      return true;
    }

    @OnItemLongClick(2)
    boolean packageItemLongClick(int position) {
      clickedPosition = position;
      return true;
    }

    @OnItemLongClick(3)
    protected boolean protectedItemLongClick(int position) {
      clickedPosition = position;
      return true;
    }
  }
  ...
  static final class MultipleIds {
    ...
    @OnItemLongClick({1, 2})
    boolean itemLongClick(int position) {
      clickedPosition = position;
      return true;
    }
  }
  ...
  static final class ArgumentCast {
    ...
    @OnItemLongClick(1)
    boolean itemLongClickAdapterView(AdapterView<?> view) {
      last = view;
      return true;
    }

    @OnItemLongClick(2)
    boolean itemLongClickAbsSpinner(AbsSpinner view) {
      last = view;
      return true;
    }

    @OnItemLongClick(3)
    boolean itemLongClickMyInterface(ArgumentCast.MyInterface view) {
      last = (View)view;
      return true;
    }
  }
