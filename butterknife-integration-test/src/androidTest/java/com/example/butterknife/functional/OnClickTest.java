...
@OnClick(2)
void clickTextView(TextView view) {
	last = view;
}

@OnClick(3)
void clickButton(Button view) {
	last = view;
}

@OnClick(4)
void clickMyInterface(MyInterface view) {
	last = (View)view;
}
}
...
public void argumentCast() {
	...
	public boolean post(Runnable action) {
		// Because of DebouncingOnClickListener, we run any posted Runnables
		// synchronously.
		action.run();
		return true;
	}
