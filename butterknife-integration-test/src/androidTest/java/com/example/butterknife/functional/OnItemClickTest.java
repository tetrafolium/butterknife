...
public final class OnItemClickTest {
  ...
  static final class MultipleBindings {
    ...
    @OnItemClick(1)
    void itemClick1(int position) {
      clickedPosition1 = position;
    }

    @OnItemClick(1)
    void itemClick2(int position) {
  ...
  public void multipleBindings() {
    assumeFalse("Not implemented",
                BuildConfig.FLAVOR.equals("reflect")); // TODO
  ...
  static final class Visibilities {
    ...
    @OnItemClick(1)
    public void publicItemClick(int position) {
      clickedPosition = position;
    }

    @OnItemClick(2)
    void packageItemClick(int position) {
      clickedPosition = position;
    }

    @OnItemClick(3)
    protected void protectedItemClick(int position) {
      clickedPosition = position;
    }
  }
  ...
  static final class ArgumentCast {
    ...
    @OnItemClick(1)
    void itemClickAdapterView(AdapterView<?> view) {
      last = view;
    }

    @OnItemClick(2)
    void itemClickAbsSpinner(AbsSpinner view) {
      last = view;
    }

    @OnItemClick(3)
    void itemClickMyInterface(ArgumentCast.MyInterface view) {
      last = (View)view;
    }
  }
  ...
  public void argumentCast() {
    class MySpinner extends TestSpinner implements ArgumentCast.MyInterface {
      MySpinner(Context context) { super(context); }
    }
