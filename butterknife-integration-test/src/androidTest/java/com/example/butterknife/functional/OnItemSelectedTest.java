...
public final class OnItemSelectedTest {
  ...
  static final class MultipleBindings {
    ...
    @OnItemSelected(1)
    void select1(int position) {
      selectedPosition1 = position;
    }

    @OnItemSelected(1)
    void select2(int position) {
  ...
  static final class Visibilities {
    ...
    @OnItemSelected(1)
    public void publicSelect(int position) {
      selectedPosition = position;
    }

    @OnItemSelected(2)
    void packageSelect(int position) {
      selectedPosition = position;
    }

    @OnItemSelected(3)
    protected void protectedSelect(int position) {
      selectedPosition = position;
    }
  ...
  static final class ArgumentCast {
    ...
    @OnItemSelected(1)
    void selectAdapterView(AdapterView<?> view) {
      last = view;
    }

    @OnItemSelected(2)
    void selectAbsSpinner(AbsSpinner view) {
      last = view;
    }

    @OnItemSelected(3)
    void selectMyInterface(MyInterface view) {
      last = (View)view;
    }
