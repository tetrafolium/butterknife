...
public final class OnTouchTest {
  ...
  static final class Visibilities {
    ...
    @OnTouch(1)
    public boolean publicTouch() {
      touches++;
      return true;
    }

    @OnTouch(2)
    boolean packageTouch() {
      touches++;
      return true;
    }

    @OnTouch(3)
    protected boolean protectedTouch() {
      touches++;
      return true;
    }
  }
  ...
  static final class ArgumentCast {
    ...
    @OnTouch(1)
    boolean touchView(View view) {
      last = view;
      return true;
    }

    @OnTouch(2)
    boolean touchTextView(TextView view) {
      last = view;
      return true;
    }

    @OnTouch(3)
    boolean touchButton(Button view) {
      last = view;
      return true;
    }

    @OnTouch(4)
    boolean touchMyInterface(ArgumentCast.MyInterface view) {
      last = (View)view;
      return true;
    }
  }
