...
public final class BindViewsFailureTest {
  ...
  static class NoIds { @BindViews({}) View[] actual; }
  ...
  static class NoGenericType { @BindViews(1) List actual; }
  ...
  static class BadCollection { @BindViews(1) Deque<View> actual; }
  ...
  static class ListNotView { @BindViews(1) List<String> actual; }
  ...
  static class ArrayNotView { @BindViews(1) List<String> actual; }
