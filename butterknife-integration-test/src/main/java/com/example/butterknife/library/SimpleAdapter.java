...
public View getView(int position, View view, ViewGroup parent) {
	...
	holder.length.setText(
		String.format(Locale.getDefault(), "Length: %d", word.length()));
	holder.position.setText(
		String.format(Locale.getDefault(), "Position: %d", position));
	// Note: don't actually do string concatenation like this in an adapter's
	// getView.
