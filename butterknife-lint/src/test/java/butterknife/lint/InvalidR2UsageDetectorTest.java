...
private static final TestFile R2 =
	java(""
	     + "package sample.r2;\n"
	     + "\n"
...
@Test
public void usesR2InAnnotations() {
	lint()                //
	.files(R2, BIND_TEST, //
	       java(""
	            + "package sample.r2;\n"
...
@Test
public void usesR2OutsideAnnotations() {
	lint()     //
	.files(R2, //
	       java(""
	            + "package sample.r2;\n"
...
@Test
public void usesR2WithSuppression() {
	lint() //
	.files(R2, java(""
	                + "package sample.r2;\n"
	                + "\n"
