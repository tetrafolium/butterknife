...
/**
 * Bind a method to an {@link OnLongClickListener OnLongClickListener} on the
 ...
 * OnLongClickListener#onLongClick(android.view.View)} may be used on the
 * method. <p> If the return type of the method is {@code void}, true will be
...
@ListenerClass(targetType = "android.view.View",
               ...
               method = @ListenerMethod(
                   name = "onLongClick", parameters = {"android.view.View"},
